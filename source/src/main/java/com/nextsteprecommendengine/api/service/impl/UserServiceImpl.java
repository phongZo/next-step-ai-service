package com.nextsteprecommendengine.api.service.impl;

import com.nextsteprecommendengine.api.config.SecurityConstant;
...
public class UserServiceImpl implements UserDetailsService {
   ...
   /* @Override
    ...
    public OAuth2AccessToken getAccessTokenForUser(ClientDetails client, TokenRequest tokenRequest, String password, String phone, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        ...
        if(user == null || !Objects.equals(NextStepRecommendengineConstant.STATUS_ACTIVE, user.getStatus())){
    ...
    public OAuth2AccessToken getAccessTokenForEmployee(ClientDetails client, TokenRequest tokenRequest, String password, String phone, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        ...
        if (user.getKind() != NextStepRecommendengineConstant.USER_KIND_EMPLOYEE) {
    ...
    public OAuth2AccessToken getAccessTokenForCandidate(ClientDetails client, TokenRequest tokenRequest, String password, String phone, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        ...
        if (user.getKind() != NextStepRecommendengineConstant.USER_KIND_CANDIDATE) {
    ...
    public NextStepRecommendengineJwt getAddInfoFromToken() {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (oauthDetails != null) {
                ...
                if (encodedData != null && !encodedData.isEmpty()) {
                    return NextStepRecommendengineJwt.decode(encodedData);
                }
                return null;
            }
        }
